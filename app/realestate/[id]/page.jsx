...
const page = ({params}) => {
    ...
    const contactPhone = process.env.NEXT_PUBLIC_CONTACT_PHONE || '+880 1745-525181';
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center">
                <div className="text-center max-w-md mx-auto px-6">
                    ...
                    <p className="text-gray-600 mb-8 text-lg">The property you're looking for doesn't exist or has been removed.</p>
                    <Link href="/" className="inline-block bg-red-600 hover:bg-red-700 text-white font-semibold py-3 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg">
                        Browse Properties
                    </Link>
                </div>
                ...
                <div className="relative w-full max-w-[1200px] h-[300px] sm:h-[400px] md:h-[500px] lg:h-[700px] overflow-hidden rounded-xl sm:rounded-2xl shadow-2xl">
                    ...
                    <div className="absolute bottom-3 left-3 right-3 sm:bottom-4 sm:left-4 sm:right-4 md:bottom-6 md:left-6 md:right-6 text-white">
                        ...
                        <div className="flex items-center text-sm sm:text-base md:text-lg lg:text-xl">
                            ...
                            <span className="drop-shadow-lg line-clamp-1">{data.location}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12">
                ...
                <div className="lg:col-span-2 space-y-6 sm:space-y-8">
                    ...
                    <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6 md:p-8">
                        <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-4 sm:mb-6">Property Overview</h2>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mb-4 sm:mb-6 md:mb-8">
                            <div className="text-center p-3 sm:p-4 bg-gray-50 rounded-lg sm:rounded-xl">
                                ...
                                <h3 className="font-semibold text-gray-800 text-xs sm:text-sm">Property Type</h3>
                                <p className="text-xs sm:text-sm text-gray-600">{data.type}</p>
                            </div>
                            ...
                            <div className="text-center p-3 sm:p-4 bg-gray-50 rounded-lg sm:rounded-xl">
                                ...
                                <h3 className="font-semibold text-gray-800 text-xs sm:text-sm">Price Range</h3>
                            ...
                            <div className="text-center p-3 sm:p-4 bg-gray-50 rounded-lg sm:rounded-xl">
                                ...
                                <h3 className="font-semibold text-gray-800 text-xs sm:text-sm">Location</h3>
                                <p className="text-xs sm:text-sm text-gray-600">Prime Area</p>
                            </div>
                            ...
                            <div className="text-center p-3 sm:p-4 bg-gray-50 rounded-lg sm:rounded-xl">
                                ...
                                <h3 className="font-semibold text-gray-800 text-xs sm:text-sm">Verified</h3>
                                <p className="text-xs sm:text-sm text-gray-600">Trusted</p>
                            </div>
                        </div>
                    ...
                    <div className="bg-gradient-to-r from-red-600 to-red-700 rounded-xl sm:rounded-2xl shadow-xl p-6 sm:p-8 text-white">
                        <div className="flex flex-col md:flex-row items-center justify-between">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto">
                                ...
                                <a 
                                    href={`https://wa.me/${contactPhone.replace(/\D/g,'')}?text=${encodeURIComponent(`Hello, I'm interested in ${data.title} located at ${data.location}. Is it available?`)}`}
                                    target="_blank" 
                    ...
                    <div className="lg:sticky lg:top-8 space-y-6">
                        ...
                        <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6 border-t-4 border-red-600">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex justify-between items-center py-3 border-b border-gray-100">
                                    <span className="text-gray-600 font-medium text-sm sm:text-base">Discounted Price</span>
                                ...
                                <div className="flex justify-between items-center py-3 bg-green-50 rounded-xl px-4">
                                    ...
                                    <span className="text-xl sm:text-2xl font-bold text-green-600">
                                        {(data.originalPrice - data.discountedPrice)?.toLocaleString()}৳
                                    </span>
                                </div>
                        ...
                        <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6">
                            <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-3 sm:mb-4">Property Information</h3>
                            <div className="space-y-3">
                                <div className="flex justify-between items-center">
                                    <span className="text-gray-600 text-sm sm:text-base">Type</span>
                                    <span className="font-semibold text-gray-800 text-sm sm:text-base">{data.type}</span>
                                </div>
                                <div className="flex justify-between items-center">
                                    <span className="text-gray-600 text-sm sm:text-base">Location</span>
                                    <span className="font-semibold text-gray-800 text-sm sm:text-base">{data.location}</span>
                                </div>
                                <div className="flex justify-between items-center">
                                    <span className="text-gray-600 text-sm sm:text-base">Status</span>
                                    <span className="inline-block bg-green-100 text-green-800 px-2 py-1 sm:px-3 sm:py-1 rounded-full text-xs sm:text-sm font-semibold">
                                        Available
                                    </span>
                                </div>
                            </div>
                        ...
                        <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6">
                            ...
                            <div className="space-y-4">
                                <button className="w-full bg-red-600 hover:bg-red-700 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg">
