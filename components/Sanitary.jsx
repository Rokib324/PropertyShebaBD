...
const Sanitary = () => {
  ...
  // Fallback data if no sanitary are available
  ...
  // Convert sanitary data to display format
  const allProperties = sanitary.length > 0 ? sanitary.map((sanitaryItem, index) => ({
    id: sanitaryItem._id || index,
    title: sanitaryItem.name,
    location: sanitaryItem.brand,
    originalPrice: sanitaryItem.originalPrice || sanitaryItem.price,
    discountedPrice: sanitaryItem.price,
    discount: sanitaryItem.originalPrice ? Math.round(((sanitaryItem.originalPrice - sanitaryItem.price) / sanitaryItem.originalPrice) * 100) : 0,
    image: sanitaryItem.image,
    type: sanitaryItem.category,
    description: sanitaryItem.description,
    color: sanitaryItem.color,
    material: sanitaryItem.material,
    stock: sanitaryItem.stock,
    isAvailable: sanitaryItem.isAvailable,
    features: sanitaryItem.features
  })) : fallbackProperties;
                ...
                <div className="p-4">
                  ...
                  <div className="mb-4">
                    <div className="flex items-center space-x-2">
                      {property.originalPrice && property.originalPrice > property.discountedPrice && (
                        <span className="text-lg text-gray-400 line-through">
                          {property.originalPrice.toLocaleString()}৳
                        </span>
                      )}
                      <span className="text-xl font-bold text-gray-900">
                        {property.discountedPrice?.toLocaleString() || '0'}৳
                      </span>
                    </div>
                  </div>
